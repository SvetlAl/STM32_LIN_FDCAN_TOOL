...
Rectangle {
    ...
    function setCanMode(_can1, _can2){
            ...
            bus_manager.fd_setFilterCan(1, can1_mode);
            bus_manager.fd_setFilterCan(2, can2_mode);
    }
    ...
    property bool monitor_mode: bus_manager.fd_monitorScanOn

    function setMonitorMode(option){
        if(monitor_mode == false && option === true){
            bus_manager.fd_monitorScanOn = option;
            //monitor_mode = option;
    ...
    BaseTableView_FDCAN_Monitor{
        ...
        model: bus_manager.FdCanBusMonitorModel /* MODEL */
    ...
    MltButton{
        ...
        function cmd(){
            ...
            if(!cmd_manager.AsynchRead){
                ...
                cmd_manager.start_asynch_read(4);
            }
            else{
                cmd_manager.stop_asynch_read(4);
    ...
    MltButton{
        ...
        function cmd(){
            root.forceActiveFocus();
            bus_manager.fd_saveTrace(i_filename._value);
        }
    }
    MltButton{
        id: i_load_button
        ...
        function cmd(){
            root.forceActiveFocus();
            bus_manager.fd_loadTrace(i_filename._value);
        }
    }
    ...
    RoundedTextInput{
        ...
        function update_initial_value(){
            ...
            bus_manager.fd_setFilterRange(start_id,end_id,false);
        }
    }
    ...
    MltButton{
        ...
        st_normal_color: bus_manager.fd_range_id_used ?  st_G_color : st_N_color
        function cmd(){
            root.forceActiveFocus();
            if(bus_manager.range_id_used){
                ...
                bus_manager.fd_setFilterRange(start_id, end_id, true);
            }
        }
    }
