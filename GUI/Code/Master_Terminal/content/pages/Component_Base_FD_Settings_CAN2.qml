...
Rectangle {
    ...
    Rectangle{
        ...
        MltButton{
            ...
            st_text: st_ASM_anno
            st_normal_color: device_manager.canfd2_ASM ? st_G_color : st_N_color
            function cmd(){
                root.forceActiveFocus();
                device_manager.canfd2_ASM = !device_manager.canfd2_ASM;
                changesCommitted();
            }
        }
        ...
        MltButton{
            ...
            st_button_mode: true
            st_text: st_DAR_anno
            st_normal_color: device_manager.canfd2_DAR ? st_G_color : st_N_color
            function cmd(){
                root.forceActiveFocus();
                device_manager.canfd2_DAR = !device_manager.canfd2_DAR;
                changesCommitted();
            }
        }
        ...
        MltButton{
            ...
            st_normal_color: device_manager.canfd2_FDOE ? st_G_color : st_N_color
            function cmd(){
                root.forceActiveFocus();
                device_manager.canfd2_FDOE = !device_manager.canfd2_FDOE;
                changesCommitted();
            }
        }
        ...
        MltButton{
            ...
            st_normal_color: device_manager.canfd2_BRSE ? st_G_color : st_N_color
            function cmd(){
                root.forceActiveFocus();
                device_manager.canfd2_BRSE = !device_manager.canfd2_BRSE;
                changesCommitted();
            }
        }
        //============= PXHD  ===============
        MltButton{
            ...
            st_normal_color: device_manager.canfd2_PXHD ? st_G_color : st_N_color
            function cmd(){
                root.forceActiveFocus();
                device_manager.canfd2_PXHD = !device_manager.canfd2_PXHD;
                changesCommitted();
            }
        }
        //============= EFBI  ===============
        MltButton{
            ...
            st_normal_color: device_manager.canfd2_EFBI ? st_G_color : st_N_color
            function cmd(){
                root.forceActiveFocus();
                device_manager.canfd2_EFBI = !device_manager.canfd2_EFBI;
                changesCommitted();
            }
        }
        //============= TXP  ===============
        MltButton{
            ...
            st_button_mode: true
            st_text: st_TXP_anno
            st_normal_color: device_manager.canfd2_TXP ? st_G_color : st_N_color
            function cmd(){
                root.forceActiveFocus();
                device_manager.canfd2_TXP = !device_manager.canfd2_TXP;
                changesCommitted();
            }
        }
        //============= NISO  ===============
        MltButton{
            ...
            st_normal_color: device_manager.canfd2_NISO ? st_G_color : st_N_color
            function cmd(){
                root.forceActiveFocus();
                device_manager.canfd2_NISO = !device_manager.canfd2_NISO;
                changesCommitted();
            }
        }
    } // rect
    ...
    Rectangle{
        ...
        RoundedTextInput{
            ...
            _anno: "PSC  "
            _enabled: true
            _value: device_manager.canfd2_nbtr_psc.toString()
            ...
            function update_initial_value(){
                ...
                device_manager.canfd2_nbtr_psc = _intvalue;
                changesCommitted();
            }
        }
        //============= BS1 ===============
        RoundedTextInput{
            ...
            _anno: "BS1  "
            _enabled: true
            _value: device_manager.canfd2_nbtr_tseg1.toString()
            a_txt_input.font.capitalization: Font.AllUppercase
            function update_initial_value(){
                var _intvalue = a_txt_input.text;
                // Convert hex string to integer
                var _id = parseInt(_intvalue, 10);
                device_manager.canfd2_nbtr_tseg1 = _intvalue;
                changesCommitted();
            }
        }
        //============= BS2 ===============
        RoundedTextInput{
            ...
            _anno: "BS2  "
            _enabled: true
            _value: device_manager.canfd2_nbtr_tseg2.toString()
            a_txt_input.font.capitalization: Font.AllUppercase
            function update_initial_value(){
                var _intvalue = a_txt_input.text;
                // Convert hex string to integer
                var _id = parseInt(_intvalue, 10);
                device_manager.canfd2_nbtr_tseg2 = _intvalue;
                changesCommitted();
            }
        }
        //============= SJW ===============
        RoundedTextInput{
            ...
            _anno: "SJW  "
            _enabled: true
            _value: device_manager.canfd2_nbtr_sjw.toString()
            a_txt_input.font.capitalization: Font.AllUppercase
            function update_initial_value(){
                var _intvalue = a_txt_input.text;
                // Convert hex string to integer
                var _id = parseInt(_intvalue, 10);
                device_manager.canfd2_nbtr_sjw = _intvalue;
                changesCommitted();
            }
        }
        ...
        RoundedTextInput{
            ...
            _anno: "PSC  "
            _enabled: true
            _value: device_manager.canfd2_dbtr_psc.toString()
            a_txt_input.font.capitalization: Font.AllUppercase
            function update_initial_value(){
                var _intvalue = a_txt_input.text;
                // Convert hex string to integer
                var _id = parseInt(_intvalue, 10);
                device_manager.canfd2_dbtr_psc = _intvalue;
                changesCommitted();
            }
        }
        //============= BS1 ===============
        RoundedTextInput{
            ...
            _anno: "BS1  "
            _enabled: true
            _value: device_manager.canfd2_dbtr_tseg1.toString()
            a_txt_input.font.capitalization: Font.AllUppercase
            function update_initial_value(){
                var _intvalue = a_txt_input.text;
                // Convert hex string to integer
                var _id = parseInt(_intvalue, 10);
                device_manager.canfd2_dbtr_tseg1 = _intvalue;
                changesCommitted();
            }
        }
        //============= BS2 ===============
        RoundedTextInput{
            ...
            _anno: "BS2  "
            _enabled: true
            _value: device_manager.canfd2_dbtr_tseg2.toString()
            a_txt_input.font.capitalization: Font.AllUppercase
            function update_initial_value(){
                var _intvalue = a_txt_input.text;
                // Convert hex string to integer
                var _id = parseInt(_intvalue, 10);
                device_manager.canfd2_dbtr_tseg2 = _intvalue;
                changesCommitted();
            }
        }
        //============= SJW ===============
        RoundedTextInput{
            ...
            _anno: "SJW  "
            _enabled: true
            _value: device_manager.canfd2_dbtr_sjw.toString()
            a_txt_input.font.capitalization: Font.AllUppercase
            function update_initial_value(){
                var _intvalue = a_txt_input.text;
                // Convert hex string to integer
                var _id = parseInt(_intvalue, 10);
                device_manager.canfd2_dbtr_sjw = _intvalue;
                changesCommitted();
            }
        }
