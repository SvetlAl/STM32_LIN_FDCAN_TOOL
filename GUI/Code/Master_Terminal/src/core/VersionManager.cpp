...
/********************************************************************/
/*************   Make a version list out of a raw data     **********/
/********************************************************************/
...
/********************************************************************/
/*** Look through dowloaded versions info and set the version info
     that matches current (device/interface) version              ***/
/********************************************************************/
...
bool VersionManager::isNewHardwareApplicationAvailable(){
    if(m_pConsole != nullptr) {
        if(m_pConsole->isConnected() != true) return false;
    }
