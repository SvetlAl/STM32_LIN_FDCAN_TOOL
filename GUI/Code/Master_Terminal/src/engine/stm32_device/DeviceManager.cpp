...
// Override filter model
void DeviceManager::fdcan_fill_OvrSts_from_OvrModel(){
    if(m_FdcanOverrideFilterModel.length() == 0) return;
    m_FdcanOverrideFilterModel.fill_OverrideStatus(&m_FdcanOverrideStatus);
}
void DeviceManager::fdcan_update_OvrModel_from_OvrSts(){
    m_FdcanOverrideFilterModel.update_model_from_OverrideStatus(&m_FdcanOverrideStatus);
}
/********************************************************************
 *
 *
...
bool DeviceManager::isMemchipNand()const{
    switch(targetDeviceData.deviceModel.memChipModel){
    case MEMCHIP_MODEL_DEFAULT: return false;
    case MEMCHIP_MODEL_MX25L323: return false;
    case MEMCHIP_MODEL_M45PE16: return false;
    case MEMCHIP_MODEL_MX25L16: return false;
    case MEMCHIP_MODEL_W25Q16: return false;
    case MEMCHIP_MODEL_MX35LF1GE4A: return true;
...
void DeviceManager::setVal_FDCAN_freq(int new_value){
    targetDeviceData.deviceModel.can_periph_freq = static_cast<eDeviceFunctionMode>(new_value);
    emit changed();
}
...
const QString DeviceManager::memchip_name() const{
    ...
    case MEMCHIP_MODEL_MX25L16:
        return "MX25L16";
        break;
    case MEMCHIP_MODEL_MX35LF1GE4A:
        return "MX35LF1GE4A";
        break;
    case MEMCHIP_MODEL_W25Q16:
        return "W25Q16";
        break;
...
const QByteArray DeviceManager::getFdcanOvrFilterData() const{
    return m_FdcanOverrideStatus.getRawData();
}
