...
void QVehicleNames_ModelProperty::init (){
    ...
    _item = QSharedPointer<QVehicle_ModelItem>
        (new QVehicle_ModelItem(this, "UAZ Patriot", MODEL_UAZ_PATRIOT, Vehicle::ModelBrand::Uaz));
    this->append(_item);

    _item = QSharedPointer<QVehicle_ModelItem>
        (new QVehicle_ModelItem(this, "Jeep Grand Cherokee17", MODEL_JEEP_GCHER_2017, Vehicle::ModelBrand::Jeep));
    this->append(_item);
