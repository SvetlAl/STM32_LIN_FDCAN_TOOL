#include "QLinOverrideFilter_ModelProperty.h"
...
********************************************************************/
/*
void QLinOverrideFilter_ModelProperty::fill_OverrideStatus(OverrideStatus* ovr_sts) const{
...
//********************************************************************************************************************
/*
void QLinOverrideFilter_ModelProperty::update_model_from_OverrideStatus(OverrideStatus* ovr_sts){
    clear();
...
//====================== Enable/Disable =============================
/*
void QLinOverrideFilter_ModelProperty::enable_filter(const int i, bool _value){
...
void QLinOverrideFilter_ModelProperty::set_lin_filter_values(const int i, lin_filter_raw* filter){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    filter->filter.id = val_ptr->Id_value();
    filter->filter.msk = val_ptr->msk();
    filter->filter.data[0] = val_ptr->byte0();
    filter->filter.data[1] = val_ptr->byte1();
    filter->filter.data[2] = val_ptr->byte2();
    filter->filter.data[3] = val_ptr->byte3();
    filter->filter.data[4] = val_ptr->byte4();
    filter->filter.data[5] = val_ptr->byte5();
    filter->filter.data[6] = val_ptr->byte6();
    filter->filter.data[7] = val_ptr->byte7();
}

//====================== Id Value =============================
const void QLinOverrideFilter_ModelProperty::set_str_id_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->str_set_id_value(_new_val);
}

//====================== Byte Value =============================
const void QLinOverrideFilter_ModelProperty::set_byte0_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setStr_byte0(_new_val);
}
const void QLinOverrideFilter_ModelProperty::set_byte1_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setStr_byte1(_new_val);
}
const void QLinOverrideFilter_ModelProperty::set_byte2_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setStr_byte2(_new_val);
}
const void QLinOverrideFilter_ModelProperty::set_byte3_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setStr_byte3(_new_val);
}
const void QLinOverrideFilter_ModelProperty::set_byte4_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setStr_byte4(_new_val);;
}
const void QLinOverrideFilter_ModelProperty::set_byte5_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setStr_byte5(_new_val);
}
const void QLinOverrideFilter_ModelProperty::set_byte6_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setStr_byte6(_new_val);
}
const void QLinOverrideFilter_ModelProperty::set_byte7_value(const int i, const QString &_new_val){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setStr_byte7(_new_val);
}
const void QLinOverrideFilter_ModelProperty::enable_byte0(const int i, bool _on){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setByte0_on(_on);
}
const void QLinOverrideFilter_ModelProperty::enable_byte1(const int i, bool _on){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setByte1_on(_on);
}
const void QLinOverrideFilter_ModelProperty::enable_byte2(const int i, bool _on){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setByte2_on(_on);
}
const void QLinOverrideFilter_ModelProperty::enable_byte3(const int i, bool _on){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setByte3_on(_on);
}
const void QLinOverrideFilter_ModelProperty::enable_byte4(const int i, bool _on){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setByte4_on(_on);
}
const void QLinOverrideFilter_ModelProperty::enable_byte5(const int i, bool _on){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setByte5_on(_on);
}
const void QLinOverrideFilter_ModelProperty::enable_byte6(const int i, bool _on){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
    val_ptr->setByte6_on(_on);
}
const void QLinOverrideFilter_ModelProperty::enable_byte7(const int i, bool _on){
    QSharedPointer<QLinOverrideFilter_ModelItem> val_ptr = dataPtr(i);
