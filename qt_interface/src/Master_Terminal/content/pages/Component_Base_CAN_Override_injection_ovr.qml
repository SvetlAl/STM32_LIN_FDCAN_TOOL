...
Rectangle {
    ...
    //================================================
    Rectangle{
        id: i_from_memchip_section
        y: 0 // i_crop_time_section.y + i_crop_time_section.height + vertical_gap
        anchors.horizontalCenter: root.horizontalCenter
        height: (vertical_gap * 16) + ((st_initial_item_height + vertical_gap)*4)
        ...
        Text{
            id: i_from_memchip_label
            y: 0
            x: i_from_memchip_section.radius
            width: i_from_memchip_section.width
            color: st_font_color
            text: st_from_memchip_anno
            font.pixelSize: st_initial_item_height/2
        }

        CentralButton{
            id: i_from_memchip_start_button
            anchors.horizontalCenter: i_from_memchip_section.horizontalCenter
            y: i_from_memchip_label.y + i_from_memchip_label.height + vertical_gap
        ...
        RoundedTextInput{
            id: i_filename
            y:  i_from_memchip_start_button.y // (i_connect_button.y + i_connect_button.height + vertical_gap*2)
        ...
        MltButton{
            ...
            anchors.bottom: i_from_memchip_start_button.bottom
        ...
        MltButton{
            ...
            x: i_from_memchip_section.x + i_from_memchip_section.width - width - composition_side_crop*2 //i_filename.x
            y: i_from_memchip_start_button.y // i_filename.y + i_filename.height + vertical_gap
            //anchors.bottom: i_filename.bottom
            height: st_initial_item_height
            width: (root.width * st_side_crop)/3  - composition_side_crop
        ...
        BaseTextField{
            id: i_textfield
            y: (i_can_reverse_button.y + i_can_reverse_button.height + vertical_gap)
            height: st_initial_item_height*3
            width: (root.width * st_side_crop) - composition_side_crop
            anchors.horizontalCenter: i_from_memchip_section.horizontalCenter
    ...
    Rectangle{
        ...
        MltButton{
            ...
            function cmd(){
                root.forceActiveFocus();
                bus_manager.loadTrace(i_from_com_port_filename._value);
            }
        }
