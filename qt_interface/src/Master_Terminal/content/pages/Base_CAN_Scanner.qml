...
Base {
    ...
    BaseTableViewCANMonitor{
        ...
        height: options_mode ? i_crop_time_button.y - vertical_gap : i_monitor_trace_button.y - vertical_gap
    ...
    RoundedTextInput{
        id: i_filename
        x: i_add_button.x
        y: i_add_button.y - i_add_button.height - vertical_gap
    ...
    RoundedTextInput{
        id: i_del_id_start
        x: i_add_button.x
        y: i_id_start.y - i_id_start.height - vertical_gap
        visible: options_mode
        width: ((root.width * st_side_crop)/2.5) - composition_side_crop
        _anno: "start id"
        _enabled: true
