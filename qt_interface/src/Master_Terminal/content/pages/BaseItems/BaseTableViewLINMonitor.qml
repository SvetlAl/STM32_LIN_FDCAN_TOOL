...
Rectangle {
    ...
    readonly property string st_secondary_color_mark_value_0: "SLAVE D";
    readonly property string st_secondary_color_mark_value_1: "SLAVE";
    /********* alias ********/
            ...
            TableView {
                ...
                delegate: Rectangle {
                    ...
                    TextEdit {
                        ...
                        text: column === 0 ? modelData.lin :
                                             column === 1 ? modelData.id :
                                                            column === 2 ? modelData.length :
                                                                           column === 3 ? modelData.data :
                                                                                          column === 4 ? modelData.period : modelData.count
                        color: (modelData.lin === st_secondary_color_mark_value_0 || modelData.lin === st_secondary_color_mark_value_1)? st_font_color2 : st_font_color //i_delegate.delegate_color
                        font.pixelSize: st_font_sz
...
Component.onCompleted: {
                            color = Qt.binding(function() {
                                if((root.model.getLin(row) === st_secondary_color_mark_value_0) || (root.model.getLin(row) === st_secondary_color_mark_value_1))
                                    return st_font_color;
                                else return st_font_color2;
                            })
                        }*/
