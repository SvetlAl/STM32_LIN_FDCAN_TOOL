...
Rectangle {
    ...
    MltButton{
        ...
        function cmd(){
            root.forceActiveFocus();
            bus_manager.saveTrace(i_filename_main._value);
        }
    }
    MltButton{
        id: i_load_button
        ...
        function cmd(){
            root.forceActiveFocus();
            bus_manager.loadTrace(i_filename_main._value);
        }
    }
    ...
    RoundedTextInput{
        ...
        _anno: "Items "
        _enabled: false
        st_clr_text: bus_manager.aux_trace_size == 0 ? CoreImport._SimpleItems_Color_FrameDisabled : "#FFFF33"
        _value: bus_manager.aux_trace_size
    }
    ...
    MltButton{
        ...
        function cmd(){
            root.forceActiveFocus();
            bus_manager.loadAuxTrace(i_filename_aux._value);
        }
    }
    ...
    Rectangle{
        ...
        y: i_crop_time_section.y + i_crop_time_section.height + vertical_gap
        anchors.horizontalCenter: root.horizontalCenter
        ...
        MltButton{
            ...
            function cmd(){
                root.forceActiveFocus();
                bus_manager.deleteRangeTrace(start_del_id, end_del_id);
            }
        }
        ...
        RoundedTextInput{
            id: i_del_time_start
            x: i_del_id_start.x
            y: i_del_id_start.y + i_del_id_start.height + vertical_gap
        ...
        MltButton{
            ...
            function cmd(){
                root.forceActiveFocus();
                bus_manager.deleteTimeRangeTrace(i_del_time_start._value, i_del_time_end._value)
            }
        }
    }
    //************************************************************************
    ...
    Rectangle{
        ...
        MltButton{
            ...
            function cmd(){
                root.forceActiveFocus();
                bus_manager.createNewTraceItem("", true);
            }
        }
        ...
        MltButton{
            ...
            function cmd(){
                root.forceActiveFocus();
                bus_manager.deleteSelectedTrace();
            }
        }
    ...
    Rectangle{
        ...
        MltButton{
            ...
            function cmd(){
                root.forceActiveFocus();
                bus_manager.setTraceIdDirection(conversion_id, 1);
            }
        }
        ...
        MltButton{
            ...
            function cmd(){
                root.forceActiveFocus();
                bus_manager.setTraceIdDirection(conversion_id, 2);
            }
        }
        ...
        MltButton{
            ...
            function cmd(){
                root.forceActiveFocus();
                bus_manager.deleteRangeTrace(conversion_id, conversion_id);
            }
        }
    }
