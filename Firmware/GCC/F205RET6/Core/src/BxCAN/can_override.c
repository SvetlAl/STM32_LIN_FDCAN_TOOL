...
#else
//====================================================================================================================
//============ Example custom calibration. Changes byte values if the message id is (0x6FF) ==========================
//====================================================================================================================
		if(CAN_ID(newMessage) == 0x6FF){
			newMessage->data[0] = 0x00;
			newMessage->data[1] = 0x01;
			newMessage->data[2] = 0x02;
			newMessage->data[3] = 0x03;
			newMessage->data[4] = 0x04;
			newMessage->data[5] = 0x05;
			newMessage->data[6] = 0x06;
			newMessage->data[7] = 0x07;
		}
#endif
