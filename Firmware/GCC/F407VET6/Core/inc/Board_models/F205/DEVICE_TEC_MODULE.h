#ifndef DEVICE_MODELS_DEVICE_TEC_MODULE_H_INCLUDED
#define DEVICE_MODELS_DEVICE_TEC_MODULE_H_INCLUDED
...
#endif // DEVICE_TEC_MODULE

#endif // DEVICE_MODELS_DEVICE_TEC_MODULE_H_INCLUDED
