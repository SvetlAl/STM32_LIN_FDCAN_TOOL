...
#define FLUSH_FIFO_TIMEOUT          20000U
#define DTFXSTS_TIMEOUT             20000U   //TODO

#define RX_FIFO_SIZE                36U      // 35 - minimum working   / 128
#define TX_EP0_FIFO_SIZE            16U      // 16 - minimum working  64
#define TX_EP1_FIFO_SIZE            320U-(RX_FIFO_SIZE+TX_EP0_FIFO_SIZE)  // 128
#define TX_EP2_FIFO_SIZE            0U
#define TX_EP3_FIFO_SIZE            0U

#define EP1_DTFXSTS_SIZE            TX_EP1_FIFO_SIZE	/* TX FIFO empty level */
#define EP1_MIN_DTFXSTS_LVL         16U               /* Minimum TX FIFO empty level */

#define MAX_CDC_EP0_TX_SIZ          64U               /* Max TX transaction size for EP0. "64" means that you can send maximum one packet of max size
in TXCallback, then you send the rest bytes (or ZLP) in next function call. Max USB_OTG_DIEPTSIZ_XFRSIZ value.     */
#define MAX_CDC_EP1_TX_SIZ          64U*8U            /* Max TX transaction size for EP1.  Max USB_OTG_DIEPTSIZ_XFRSIZ value.      */
